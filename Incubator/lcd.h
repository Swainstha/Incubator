...
#define	LCD_RS_PORT PORTH		//R/S line
#define	LCD_RS_PIN	6

#define LCD_D7_PORT PORTG
#define LCD_D7_PIN	5
#define LCD_D6_PORT PORTE
#define LCD_D6_PIN	3
#define LCD_D5_PORT PORTH
#define LCD_D5_PIN	3
...
#define 	LCD_START_LINE3   0x14          //0x10 for 16*4 lcd 

#define 	LCD_START_LINE4   0x54          //0x50  for 16*4 lcd
...
void lcd_init()
{
	...
	lcd_write(0b00001110);	// Display On, Cursor Off, Cursor Blink off
